...
1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/iuscaler/kocom_wallpad_app_for_homeassistant 를 입력한 다음 ADD 버튼을 누릅니다.
...
[github]: https://github.com/iuscaler/kocom_wallpad_app_for_homeassistant
